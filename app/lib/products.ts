...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    faqs: [
      ...
      { q: "Can I buy edibles at Queensway Cannabis Dispensary?", a: "Yes! Visit us at 1174 The Queensway, Etobicoke. We're open daily 24 hours with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
  ...
  CIGARETTES: {
    ...
    seoDescription: "Queensway Cannabis Dispensary is your go-to source for affordable native cigarettes in Etobicoke. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 1174 The Queensway in the heart of ByWard Market, we're open daily 24 hours. Stop by for the best cigarette prices in the neighbourhood.",
    faqs: [
