...
export const metadata: Metadata = {
  title: "FAQ — Queensway Cannabis Dispensary | Etobicoke Dispensary Questions",
  description:
    "Frequently asked questions about Queensway Cannabis Dispensary in Etobicoke. Hours, location, products, pricing, promotions, and everything you need to know before visiting.",
  alternates: {
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      { q: "Where is Queensway Cannabis Dispensary located?", a: "We are located at 1174 The Queensway, Etobicoke, ON M8Z 1R5. We're easily accessible by TTC bus routes and close to major highways like the 401." },
      { q: "What are your hours?", a: "We are open daily from 10:00 AM to 12:00 AM. Walk in anytime — no appointment needed." },
      ...
      { q: "What's the best way to get to Queensway Cannabis Dispensary?", a: "We're easily accessible by car, bus, or foot. We are easily accessible by car, local transit, or bus routes. Free parking is available on surrounding streets." },
    ],
  },
  {
    title: "🌿 Products & Menu",
    faqs: [
      ...
      { q: "Do you have a live menu?", a: "Yes! Our online menu at queenswaycannabisdispensary.com updates in real time with current stock, prices, THC levels, and availability. You can check what's in stock before you visit." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Do I need an appointment?", a: "No! Queensway Cannabis Dispensary is walk-in only. Just show up anytime — we are open daily from 10:00 AM to 12:00 AM." },
      { q: "Can I order online?", a: "Currently, Queensway Cannabis Dispensary is an in-store shopping experience only. You can browse our live menu online to see what's in stock before visiting." },
      ...
      <main className={styles.main}>
        ...
        <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
          <img
            ...
            alt="Queensway Cannabis Dispensary FAQ — Your Questions Answered"
        ...
        <div className={styles.content}>
          ...
          <p className={styles.pageSubtitle}>
            Everything you need to know about Queensway Cannabis Dispensary — Etobicoke&apos;s premium dispensary at 1174 The Queensway in Etobicoke.
          </p>
