"""
Queensway Cannabis Dispensary - Auto Sync from Google Sheets
==========================================
...
a filtered menu for Queensway Cannabis Dispensary (ALC01).
...
def main():
    print("=" * 60)
    print(f"  Queensway Cannabis Dispensary - Product Sync (Store: {STORE_CODE})")
    print("=" * 60)
    print()
    ...
    if do_deploy:
        ...
        if result.returncode == 0:
            print("  [OK] Live at https://queenswaycannabisdispensary.com")
        else:
            print(f"  Output:\n{result.stdout[-500:]}")
    else:
