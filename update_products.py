"""
Queensway Cannabis Dispensary — Product Update Script
===================================
Drop your ONHAND CSV into the queensway-cannabis folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  Queensway Cannabis Dispensary — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://queenswaycannabisdispensary.com")
    else:
