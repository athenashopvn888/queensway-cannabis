...
/* ============================================================
   ...
   ============================================================ */
const TICKER_SLIDES = [
  "🔥 Queensway Cannabis Dispensary — 1174 The Queensway, Etobicoke",
  "200+ Strains In Stock",
  "Open 24 Hours",
  "ALL SALES ARE FINAL",
  "🎮 Play Games at queenswaycannabisdispensary.com/games",
];
    ...
    <div className={styles.tvPage}>
      ...
      <div className={styles.wrap} ref={wrapRef}>
        ...
        <div style={{ margin: "-40px -40px 30px -40px", width: "calc(100% + 80px)" }}>
          <img src="/banners/FlowerTvBanner.webp" alt="Queensway Cannabis Dispensary TV Menu" style={{ width: "100%", display: "block" }} />
        </div>
