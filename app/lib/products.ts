...
export async function fetchLiveProducts(): Promise<{
  ...
  try {
    const res = await fetch(`${APPS_SCRIPT_URL}?store=QCD01`, {
...
> = {
  EXOTIC: {
    ...
    color: "#f59e0b",
    icon: "\uD83D\uDD25",
    tagline: "Explore the Exotic Weed flower collection",
  ...
  PREMIUM: {
    ...
    color: "#a78bfa",
    icon: "\uD83D\uDC8E",
    tagline: "Explore the Premium Weed flower collection",
  ...
  "AAA+": {
    ...
    color: "#22d3ee",
    icon: "\u26A1",
    tagline: "Explore the AAA+ Weed flower collection",
  ...
  AA: {
    ...
    color: "#34d399",
    icon: "\u2726",
    tagline: "Explore the AA Weed flower collection",
  ...
  BUDGET: {
    ...
    color: "#94a3b8",
    icon: "\uD83D\uDCB0",
    tagline: "Explore the Budget Weed flower collection",
...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoIntro: "Browse the full cannabis edibles menu at Queensway Cannabis Dispensary on Etobicoke St, Etobicoke. We carry THC gummies, chocolates, drinks, and more from top Canadian brands.",
    seoDescription: "Looking for cannabis edibles in Etobicoke? Queensway Cannabis Dispensary stocks a wide range of THC-infused gummies, chocolates, beverages, and baked goods. Our edibles range from micro-dose options for beginners to high-potency products for experienced consumers. All products are lab-tested and sourced from licensed Canadian producers. Visit us at 1174 The Queensway — we are open 24 hours a day, 7 days a week.",
    faqs: [
      ...
      { q: "Can I buy edibles at Queensway Cannabis Dispensary?", a: "Yes! Visit us at 1174 The Queensway, Etobicoke. We're open 24 hours a day, 7 days a week with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
    banner: "/banners/01_Vape_Pens.webp",
    name: "Nicotine Vape", slug: "vapes", color: "#8b5cf6", icon: "💨",
    seoTitle: "Nicotine Vapes Etobicoke | Queensway Cannabis Dispensary",
    seoIntro: "Queensway Cannabis Dispensary keeps nicotine vape products separate from THC Vape products so shoppers can clearly distinguish the two categories. Nicotine products are for adults 19+ and contain nicotine, which is addictive.",
    seoDescription: "Queensway Cannabis Dispensary keeps nicotine vape products separate from THC Vape products so shoppers can clearly distinguish the two categories. Nicotine products are for adults 19+ and contain nicotine, which is addictive.",
    faqs: [
      { q: "Is this the nicotine vape category?", a: "Yes. This page is for nicotine vape products and is kept separate from the THC Vape category." },
      { q: "Are nicotine products age restricted?", a: "Yes. Nicotine products are for adults 19+ and contain nicotine, which is addictive." },
    ],
  },
  "VAPE DISPOSABLE": {
    banner: "/banners/02_Vape_Disposable.webp",
    name: "THC Vape", slug: "vape-disposables", color: "#a78bfa", icon: "💨",
    seoTitle: "THC Vapes Etobicoke | Queensway Cannabis Dispensary",
    seoIntro: "Browse the Queensway Cannabis Dispensary THC Vape category, kept separate from Nicotine Vape products.",
    seoDescription: "Browse the Queensway Cannabis Dispensary THC Vape category, kept separate from Nicotine Vape products.",
    faqs: [
      { q: "Is this the THC Vape category?", a: "Yes. This page is for THC Vape products and is kept separate from the Nicotine Vape category." },
    ],
  },
  CONCENTRATES: {
  ...
  PREROLLS: {
    ...
    seoIntro: "Pre-rolled cannabis joints at Queensway Cannabis Dispensary, Etobicoke. Singles, multi-packs, and infused pre-rolls — ready to light up.",
    seoDescription: "Skip the rolling and grab a pre-roll from Queensway Cannabis Dispensary in Etobicoke. We carry singles, multi-packs, and infused pre-rolls from premium flower. Whether you want a quick smoke or a party pack, our pre-roll selection has something for everyone. Visit us at 1174 The Queensway — we are open 24 hours a day, 7 days a week.",
    faqs: [
  ...
  "ADD ONS": {
    ...
    seoIntro: "Essential cannabis accessories at Queensway Cannabis Dispensary, Etobicoke. Grinders, rolling papers, lighters, trays, and more.",
    seoDescription: "Queensway Cannabis Dispensary carries all the accessories you need for the perfect smoke session. From premium grinders and rolling papers to lighters, trays, and storage containers, we have everything in stock. Visit us at 1174 The Queensway, Etobicoke.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    seoTitle: "Native Cigarettes Etobicoke — Discount Tobacco at Queensway Cannabis Dispensary",
    seoIntro: "Discount native cigarettes at Queensway Cannabis Dispensary, Etobicoke. Premium and value brands at the best prices on Etobicoke St.",
    seoDescription: "Queensway Cannabis Dispensary is your go-to source for affordable native cigarettes in Etobicoke. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 1174 The Queensway in the heart of 1174 The Queensway & Nearby Expressway, we're Open 24 Hours.",
    faqs: [
      { q: "Do you sell cigarettes at Queensway Cannabis Dispensary?", a: "Yes! We carry a wide selection of native cigarette brands at competitive prices." },
      ...
      { q: "Are your cigarette prices competitive?", a: "Absolutely. We offer some of the best cigarette prices in the 1174 The Queensway & Nearby Expressway area of Etobicoke." },
    ],
  },
};
