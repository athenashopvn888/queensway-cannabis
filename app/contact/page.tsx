...
export const metadata: Metadata = {
  ...
  description:
    "Visit Queensway Cannabis Dispensary at 1174 The Queensway, Etobicoke, ON M8Z 1R5. Open 24 hours, 7 days a week. Walk-ins welcome.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "1174 The Queensway, Etobicoke. Open 24 hours, 7 days a week. Premium cannabis, always fire.",
  },
};
