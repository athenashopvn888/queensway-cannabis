...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    faqs: [
      ...
      { q: "Can I buy edibles at Queensway Cannabis Dispensary?", a: "Yes! Visit us at 1174 The Queensway, Etobicoke. We're open daily from 10:00 AM to 12:00 AM with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
  ...
  "VAPE DISPOSABLE": {
    ...
    seoIntro: "THC disposable vapes available at Queensway Cannabis Dispensary, Etobicoke. No charging, no refilling — just open and enjoy.",
    seoDescription: "Disposable THC vapes are the easiest way to enjoy cannabis on the go. Queensway Cannabis Dispensary stocks a wide selection of pre-charged, pre-filled disposable vape pens with various strain profiles and potencies. Perfect for beginners and experienced users alike. Visit us at 1174 The Queensway, Etobicoke.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    seoDescription: "Queensway Cannabis Dispensary is your go-to source for affordable native cigarettes in Etobicoke. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 1174 The Queensway in the heart of 1174 The Queensway & Nearby Expressway, we're Open Daily: 10:00 AM - 12:00 AM.",
    faqs: [
  ...
  "MAGIC & OTHERS": {
    ...
    seoIntro: "Magic mushrooms, psilocybin products, and specialty items at Queensway Cannabis Dispensary, Etobicoke.",
    seoDescription: "Queensway Cannabis Dispensary carries a curated selection of magic mushrooms and specialty products in Etobicoke. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 1174 The Queensway for our full selection.",
    faqs: [
